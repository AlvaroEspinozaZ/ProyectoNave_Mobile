...
{ //MIxamo
  //Sketchfab
    ...
    [SerializeField] private float inclinacionz=0;
    [SerializeField] private float inclinaciony = 0;
    [SerializeField] private float inclinacionx = 0;
    ...
    void Start()
    {
        ...
        angulos = new Vector3(inclinacionx, inclinaciony, inclinacionz);
